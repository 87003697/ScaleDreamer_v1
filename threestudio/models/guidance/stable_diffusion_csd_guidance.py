...
@threestudio.register("stable-diffusion-classifier-score-distillation-guidance")
class StableDiffusionClassifierGuidance(BaseObject):
    @dataclass
    ...
    def get_noise_pred(
        ...
        if use_perp_neg:
            ...
            noise_pred = noise_pred_text + self.cfg.cond_scale * (
