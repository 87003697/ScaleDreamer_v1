 u6saaCUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python launch.py \
    --config configs/group_18/DE+MJ__vae-fix__vol_30_def-1_nobg__sd-0.1-7.5-v0_mv-20-v1_rd-20-v1__eik_1-0_spars_1-0_eps_1.yaml \
    --train \
